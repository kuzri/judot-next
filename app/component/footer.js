  ...
  return (
    <footer className={`${styles.footer} ${isDarkMode ? styles.footerDark : styles.footerLight}`}>
      <div className={styles.footerContainer}>
        ...
        {/* 방문자 통계 */}
        <div className={`${styles.visitorStats} ${isDarkMode ? styles.visitorStatsDark : styles.visitorStatsLight}`}>
          <div className={styles.visitorStatsContainer}>
            <div className={styles.visitorStatItem}>
              <span className={`${styles.koreanFont} ${styles.visitorStatLabel}`}>Today</span>
              <span className={`${styles.visitorStatValue} ${styles.visitorStatToday}`}>
                {visitorStats.today.toLocaleString()}
              </span>
            </div>
            <div className={styles.visitorStatDivider}>|</div>
            <div className={styles.visitorStatItem}>
              <span className={`${styles.koreanFont} ${styles.visitorStatLabel}`}>Total</span>
              <span className={`${styles.visitorStatValue} ${styles.visitorStatTotal}`}>
          ...
          {visitorStats.error && (
            <p className={`${styles.koreanFont} ${styles.visitorStatError}`}>
              {visitorStats.error}
            </p>
          )}
        </div>
